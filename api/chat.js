...
const SITE_CONTEXT = `
Данные о сайте:
- Бренд: Центр ментального здоровья Азимут Медлайн.
- Телефон: +7(905)27-277-03.
...
const SYSTEM_PROMPT = `
Ты виртуальный помощник сайта «Центр ментального здоровья Азимут Медлайн».
...
- предлагать оставить заявку или позвонить по телефону +7(905)27-277-03;
